...
# Day 3: Tool implementations for the Orchestrator's Trip Planner agent
# (Copy from your Day 2 work, or implement here)
...
#
# Tip: You already built this in Day 2! Copy your implementation from
#      src/day-2/trip-planner/tools.py or rewrite it here.
# =============================================================================
def search_flights(origin: str, destination: str, date: str) -> dict:
    """Search for available flights between two cities on a specific date."""
    # TODO: Implement this tool (or copy from Day 2)
    pass
...
#     name, rating, price_per_night_usd, neighborhood, amenities[]
# =============================================================================
...
#
# Returns:
#   dict with: flights_total, hotel_total, food_total, activities_total,
